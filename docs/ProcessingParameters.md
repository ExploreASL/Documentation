...
| `bMultiTEQuantification`                  | If set to 1, multi-TE quantification is enabled in case that multi-TE data are present. It is enabled by default when mutli-TE data are detected. | OPTIONAL, DEFAULT = true|
