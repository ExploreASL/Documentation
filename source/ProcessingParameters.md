...
| `ExternalQuantificationSmoothGaussianMM`           | Pre-smooth the raw PWI maps with a Gaussian filter before running 'BASIL', 'FABBER', 'VABY'. Provide a vector of 3 values specifying FWHM of the Gaussian filter in mm. | OPTIONAL, DEFAULT=[] |
